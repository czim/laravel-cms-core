 ...
 */
class CreateOauthAccessTokensTable extends CmsMigration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create($this->prefixCmsTable('oauth_access_tokens'), function (Blueprint $table) {
            ...
            $table->foreign('session_id', $this->prefixCmsTable('oauth_access_tokens_session_id_foreign'))
    ...
    {
        Schema::table($this->prefixCmsTable('oauth_access_tokens'), function (Blueprint $table) {
            $table->dropForeign($this->prefixCmsTable('oauth_access_tokens_session_id_foreign'));
        });
